...
// ctor
///////////////////////////////////////////////////////////////////////////////
Sphere::Sphere(glm::vec3 position, float radius, int sectors, int stacks, bool smooth) : interleavedStride(32)
{
    _position = position;
    ...
    float* data = new float[this->interleavedVertices.size()];
    data = &this->interleavedVertices[0];
    glBufferData(GL_ARRAY_BUFFER, sizeof(this->interleavedVertices), data, GL_STATIC_DRAW);
...
///////////////////////////////////////////////////////////////////////////////
void Sphere::Draw(Camera* camera, std::vector<Light*> lights)  {
...
///////////////////////////////////////////////////////////////////////////////
void Sphere::drawLines(const float lineColor[4]) 
{
    // set line colour
...
// the caller must set the line width before call this
///////////////////////////////////////////////////////////////////////////////
void Sphere::drawWithLines(Camera* camera, std::vector<Light*> lights, const float lineColor[4]) 
{
    glEnable(GL_POLYGON_OFFSET_FILL);
    glPolygonOffset(1.0, 1.0f); // move polygon backward
    this->Draw(camera, lights);
