...
public:
	...
	void Draw(Camera* camera, std::vector<Light*> lights) {
		...
		if (lights[1]->_destroyed) {
			shader->SetVector3f("pointLights[1].diffuse", glm::vec3(0.0f));
			shader->SetVector3f("pointLights[1].specular", glm::vec3(0.0f));
		}
		else {
		...
		if (lights[2]->_destroyed) {
			shader->SetVector3f("pointLights[2].diffuse", glm::vec3(0.0f));
			shader->SetVector3f("pointLights[2].specular", glm::vec3(0.0f));
		}
		else {
		...
		if (lights[3]->_destroyed) {
			shader->SetVector3f("pointLights[3].diffuse", glm::vec3(0.0f));
			shader->SetVector3f("pointLights[3].specular", glm::vec3(0.0f));
		}
		else {
		...
		if (lights[4]->_destroyed) {
			shader->SetVector3f("pointLights[4].diffuse", glm::vec3(0.0f));
			shader->SetVector3f("pointLights[4].specular", glm::vec3(0.0f));
		}
		else {
		...
		if (lights[5]->_destroyed) {
			shader->SetVector3f("pointLights[5].diffuse", glm::vec3(0.0f));
			shader->SetVector3f("pointLights[5].specular", glm::vec3(0.0f));
		}
		else {
